...
Die öffentliche IFC-Dokumentation bestätigt, dass [`Pset_WallCommon`](https://ifc43-docs.standards.buildingsmart.org/IFC/RELEASE/IFC4x3/HTML/lexical/Pset_WallCommon.htm) für Wände `LoadBearing` und `IsExternal` als Ja-/Nein-Eigenschaften definiert. Da `openbim.ifc` `0.2.0` noch keine typisierten PSD/QTO-Vorkommen enthält, bleiben diese Beispiele projektlokal; die Links sind Belege, keine paket-eigenen IFC-Identitätsbindungen.
