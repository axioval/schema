...
Because `openbim.ifc` `0.2.0` does not yet bundle typed PSD/QTO occurrences,
these example properties remain project-local; the links are evidence, not
package-owned IFC identity bindings.
