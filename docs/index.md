...
Imagine an object marked as cost group **331**. The project says that every such object must be:

1. a wall;
2. load bearing; and
3. external.

Axioval keeps these three questions separate. A wrong object cannot disappear from the check just because it is not already called a wall.
...
[Walk through this example](tutorials/din-276-331.md){ .md-button .md-button--primary }

<div class="technical-door" markdown>

**Already building a tool?** Continue to the [tool builder pages](concepts/layers.md) for precise file and safety details.
